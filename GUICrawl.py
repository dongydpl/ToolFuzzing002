...
"QPushButton#btnXSS:hover { background-color: #c3e6cb; border: 2px solid #155724; }")
        ...
        self.label.setGeometry(QtCore.QRect(150, 0, 731, 61))
        font = QtGui.QFont()
